    ...
    const created = await service.createPaymentMethod(
      {
        ...
        allowWeb: body.allowWeb !== undefined ? Boolean(body.allowWeb) : (body.methodType !== "CASH"),
        allowKiosk: body.allowKiosk !== undefined ? Boolean(body.allowKiosk) : true,
    ...
    const updated = await service.updatePaymentMethod(
      {
        ...
        qrImagePath: body.qrImagePath,
        instructions: body.instructions,
        allowWeb: body.allowWeb !== undefined ? body.allowWeb : (body.methodType !== "CASH"),
        allowKiosk: body.allowKiosk !== undefined ? body.allowKiosk : true,
