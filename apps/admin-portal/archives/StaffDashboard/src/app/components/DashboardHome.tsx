    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/dashboard/reservations" className="text-sm text-[#009689] hover:text-[#00796b] font-medium">
              View All
            </Link>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/dashboard/active-sessions" className="text-sm text-[#009689] hover:text-[#00796b] font-medium">
              View All
            </Link>
          </div>
          <div className="space-y-3">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/dashboard/visitor-activity" className="text-sm text-[#009689] hover:text-[#00796b] font-medium">
            View All
          </Link>
        </div>
              ...
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`text-sm font-medium ${log.statusColor}`}>
                      {log.activity}
                    </span>
                  </div>
