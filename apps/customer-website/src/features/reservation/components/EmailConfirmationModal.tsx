      ...
      >
        <DialogHeader className="flex flex-col items-center text-center pb-2">
          ...
          <DialogDescription id="email-confirm-description" className="text-xs sm:text-sm text-[var(--da-text-secondary)] mt-1 max-w-md">
            Please ensure this email is accurate. Your secure 1-hour payment session link and reservation tracking updates will be sent here.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="mt-2 rounded-xl bg-amber-50 border border-amber-200 p-3 text-[11px] text-amber-900 leading-relaxed space-y-1">
          <div className="font-bold flex items-center gap-1">
            <span>⏱️</span> 1-Hour Payment Session
          </div>
          <p>
            Upon confirmation, DeskAtlas will send your private payment link. You will have 1 hour to submit proof. Be sure to check your <strong>Spam or Junk folder</strong> if you don&apos;t see the email within a couple minutes.
          </p>
        </div>
